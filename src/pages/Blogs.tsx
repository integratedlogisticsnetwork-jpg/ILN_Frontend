...
const Blog2 = () => {
  ...
  return (
    <div className="bg-white dark:bg-[var(--bg-color1)] text-black dark:text-white min-h-screen flex flex-col">
      <Navbar />
      ...
      <div className="flex-grow py-16 px-4 sm:px-6 lg:px-8">
        ...
        {/* Error */}
        {!loading && error && (
          <div className="flex items-center justify-center py-20 text-red-500 text-lg">
            {error}
          </div>
        )}
        ...
        {!loading && !error && blogPosts.length === 0 && (
          <div className="max-w-7xl mx-auto py-20 text-center text-gray-500 dark:text-gray-400 text-xl">
            No blogs found.
          </div>
        )}
